...
printf(" glui_spinner.cpp +346, GLUI_Spinner::set_float_val, %f\n", new_val);
...
printf(" glui_spinner.cpp +531, GLUI_Spinner::set_float_limits,        low %f\n", low);
printf(" glui_spinner.cpp +531, GLUI_Spinner::set_float_limits,       high %f\n", high);
printf(" glui_spinner.cpp +531, GLUI_Spinner::set_float_limits, limit_type %f\n", limit_type);
