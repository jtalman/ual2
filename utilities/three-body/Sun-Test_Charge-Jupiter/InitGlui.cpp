  ...
  gldc = Glui->add_checkbox( "Intensity Depth Cue", &DepthCueOn, DEPTH, (GLUI_Update_CB) Buttons );
	...
	panel = Glui->add_panel_to_panel( bigpanel, "Display Mode" );
		group = Glui->add_radiogroup_to_panel( panel, &WhichObject );
			...
			Glui->add_radiobutton_to_group( group, "Iconic" );
...
//		rot->set_spin( 1.0 );
 ...
 spinner_S_x0  = new GLUI_Spinner( Glui, "S_x0:", &S_x0, SUN_POS, (GLUI_Update_CB) Buttons );
 spinner_S_x0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_S_y0;
 spinner_S_y0  = new GLUI_Spinner( Glui, "S_y0:", &S_y0, SUN_POS, (GLUI_Update_CB) Buttons );
 spinner_S_y0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_S_z0;
 spinner_S_z0  = new GLUI_Spinner( Glui, "S_z0:", &S_z0, SUN_POS, (GLUI_Update_CB) Buttons );
 spinner_S_z0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_M_x0;
 spinner_M_x0  = new GLUI_Spinner( Glui, "M_x0:", &M_x0, MOON_POS, (GLUI_Update_CB) Buttons );
 spinner_M_x0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_M_y0;
 spinner_M_y0  = new GLUI_Spinner( Glui, "M_y0:", &M_y0, MOON_POS, (GLUI_Update_CB) Buttons );
 spinner_M_y0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_M_z0;
 spinner_M_z0  = new GLUI_Spinner( Glui, "M_z0:", &M_z0, MOON_POS, (GLUI_Update_CB) Buttons );
 spinner_M_z0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_E_x0;
 spinner_E_x0  = new GLUI_Spinner( Glui, "E_x0:", &E_x0, SUN_POS, (GLUI_Update_CB) Buttons );
 spinner_E_x0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_E_y0;
 spinner_E_y0  = new GLUI_Spinner( Glui, "E_y0:", &E_y0, SUN_POS, (GLUI_Update_CB) Buttons );
 spinner_E_y0->set_float_limits( -100.f, 100.f );

 GLUI_Spinner    *spinner_E_z0;
 spinner_E_z0  = new GLUI_Spinner( Glui, "E_z0:", &E_z0, SUN_POS, (GLUI_Update_CB) Buttons );
