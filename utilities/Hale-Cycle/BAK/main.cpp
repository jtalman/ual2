...
//  GLUI_Spinner *spinner_PX = Glui->add_spinner_to_panel(panel1, "Point X:", GLUI_SPINNER_FLOAT, &PX, 0, (GLUI_Update_CB) Buttons );
//  GLUI_Spinner *spinner_PX;
//  spinner_PX  = new GLUI_Spinner( Glui, "Point X:", &PX, 0, (GLUI_Update_CB) Buttons );
...
//  GLUI_Spinner *spinner_PY = Glui->add_spinner_to_panel(panel1, "Point Y:", GLUI_SPINNER_FLOAT, &PY, 1, (GLUI_Update_CB) Buttons );
//  GLUI_Spinner *spinner_PY;
//  spinner_PY  = new GLUI_Spinner( Glui, "Point Y:", &PY, 1, (GLUI_Update_CB) Buttons );
...
//  GLUI_Spinner *spinner_PZ = Glui->add_spinner_to_panel(panel1, "Point Z:", GLUI_SPINNER_FLOAT, &PZ, 2, (GLUI_Update_CB) Buttons );
//  GLUI_Spinner *spinner_PZ;
//  spinner_PZ  = new GLUI_Spinner( Glui, "Point Z:", &PZ, 2, (GLUI_Update_CB) Buttons );
    ...
    spinner_step  = new GLUI_Spinner( Glui, "Step:", &S, 6, (GLUI_Update_CB) Buttons );
    spinner_step->set_int_limits( 0, 4500 );

//  GLUI_Checkbox*CB=new GLUI_Checkbox(Glui, "SHOW HOVER", 4 );
//GLUI_Checkbox*CB  =new GLUI_Checkbox(Glui, "SHOW HOVER", &H,    4, (GLUI_Update_CB) Buttons );
  GLUI_Checkbox*CB  =new GLUI_Checkbox(Glui, "SHOW HOVER", &HClk, 7, (GLUI_Update_CB) Buttons );
//GLUI_Checkbox*SClk=new GLUI_Checkbox(Glui, "SHOW CLICK", &SClk, 5, (GLUI_Update_CB) Buttons);
