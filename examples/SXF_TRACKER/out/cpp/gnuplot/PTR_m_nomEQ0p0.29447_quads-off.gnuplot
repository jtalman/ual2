# gnuplot > load "gnuplot/twiss/PTR_m_nomEQ0p0.29447_quads-off.gnuplot"
...
set output "pdf/PTR-mnom=0.0.29447-quads-off-phase-advance.pdf
set ylabel "horizontal phase advance"
 plot  "ring.twiss" using 3:6 w lp title "mnom=0p0.29447-quads-off-phase-advance"
