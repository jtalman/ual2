# gnuplot > load "gnuplot/twiss/COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplot"
...
set output "pdf/COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplotTwiss.pdf"
plot "ring.twiss" using 3:4 title "COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplot-beta_x",\
      "ring.twiss" using 3:8 title "COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplot-beta_y"

unset label
set label "deuteron,  E= 2.11 GeV,  {/Symbol b} =0.497" at 100, 25
set ylabel "D [m]"
set title "COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplot Dispersion Function"
...
set output "pdf/COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplotDispersionFunction.pdf"
plot  "ring.twiss" using 3:7 title "COSY-Vera-mx06-mx07-rf-sexts-offTwiss.gnuplot-eta_x"
