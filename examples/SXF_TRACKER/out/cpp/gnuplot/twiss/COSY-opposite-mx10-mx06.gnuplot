# gnuplot > load "gnuplot/twiss/COSY-opposite-mx10-mx06.gnuplot"
...
set title "COSY-opposite-mx10-mx06 Beta Functions"
...
set output "pdf/COSY-opposite-mx10-mx06-Twiss.pdf"
plot "ring.twiss" using 3:4 title "COSY-opposite-mx10-mx06-beta_x",\
      "ring.twiss" using 3:8 title "COSY-opposite-mx10-mx06-beta_y"

unset label 
set label "deuteron,  E= 2.11 GeV,  {/Symbol b} =0.497" at 100, 0
set ylabel "D [m]"
set title "COSY-opposite-mx10-mx06 Dispersion Function"
...
set output "pdf/COSY-opposite-mx10-mx06-DispersionFunction.pdf"
plot  "ring.twiss" using 3:7 title "COSY-opposite-mx10-mx06-eta_x"
