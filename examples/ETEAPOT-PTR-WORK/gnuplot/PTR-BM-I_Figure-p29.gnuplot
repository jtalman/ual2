# gnuplot > load "gnuplot/PTR-BM-I_Figure-p29.gnuplot"
...
#  set output '| display png:-'
 ...
 set output "pdf/Fig-p29-t.pdf"
 plot 'PTR_m_nom=0.29447_sl4.sxf__plus_X' u 2 w l, 'PTR_m_nom=0.29447_sl4.sxf_minus_X' u 2 w l
 
 set ylabel "vertical displacement, y(m)"
 set output "pdf/Fig-p29-b.pdf"
 plot 'PTR_m_nom=0.29447_sl4.sxf__plus_Y' u 2 w l, 'PTR_m_nom=0.29447_sl4.sxf_minus_Y' u 2 w l