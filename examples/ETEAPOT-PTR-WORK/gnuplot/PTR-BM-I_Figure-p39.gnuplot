# gnuplot > load "gnuplot/PTR-BM-I_Figure-p39.gnuplot"
...
#  set output '| display png:-'
 ...
 set output "pdf/Fig-p39-t.pdf"
 plot 'PTR_m_nom=0.39447_sl4.sxf__plus_X' u 2 w l, 'PTR_m_nom=0.39447_sl4.sxf_minus_X' u 2 w l
 
 set ylabel "vertical displacement, y(m)"
 set output "pdf/Fig-p39-b.pdf"
 plot 'PTR_m_nom=0.39447_sl4.sxf__plus_Y' u 2 w l, 'PTR_m_nom=0.39447_sl4.sxf_minus_Y' u 2 w l