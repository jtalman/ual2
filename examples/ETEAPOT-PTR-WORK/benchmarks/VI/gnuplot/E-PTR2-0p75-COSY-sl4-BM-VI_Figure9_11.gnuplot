# gnuplot > load "gnuplot/E-PTR2-0p75-COSY-sl4-BM-VI_Figure9_11.gnuplot"
set xlabel "longitudinal position (m)"
 ...
 set title "E-PTR2-0p75-sl4, m=0.002"
...
#  set output '| display png:-'
 ...
 set output "pdf/E-PTR2-0p75-COSY-sl4-Fig_VI-9-ETEAPOT.pdf"
 plot 'betaFunctions' u 2:3 w l

 set ylabel "vertical beta function, {/Symbol b}_y(m)"
 set output "pdf/E-PTR2-0p75-COSY-sl4-Fig_VI-11-ETEAPOT.pdf"
