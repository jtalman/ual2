...
int main(int argc,char * argv[]){
  ...
  shell.addSplit(UAL::Args() << UAL::Arg("lattice", "muon") << UAL::Arg("types", "Sbend") << UAL::Arg("ir", 4));

  shell.addSplit(UAL::Args() << UAL::Arg("lattice", "muon") << UAL::Arg("types", "Quadrupole") << UAL::Arg("ir", 4));
