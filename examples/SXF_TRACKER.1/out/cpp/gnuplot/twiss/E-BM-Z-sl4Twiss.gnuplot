# gnuplot > load "gnuplot/twiss/E-BM-Z-sl4Twiss.gnuplot"
 ...
 set title "E-BM-Z-sl4 Lattice Functions"
...
set output "pdf/E-BM-Z-sl4Twiss.pdf"

 plot "ring.twiss" using 3:4 title "E-BM-Z-sl4-beta_x",\
       "ring.twiss" using 3:8 title "E_BM-Z-sl4-beta_y",\
       "ring.twiss" using 3:7 title "E_BM-Z-sl4-eta_x"