# gnuplot > load "gnuplot/BM-I_Figure4.gnuplot"
...
set ylabel "horizontal displacement, x(m)"
 ...
 set title "cosine-like standard particles, q=-0.002019"
...
#  set output '| display png:-'
 ...
 set output "pdf/Fig_I-4t.pdf"
 plot 'E_BM_M1.0.sxf__plus_X' u 2 w l, 'E_BM_M1.0.sxf_minus_X' u 2 w l
 
 set ylabel "vertical displacement, x(m)"
 set output "pdf/Fig_I-4b.pdf"
 plot 'E_BM_M1.0.sxf__plus_Y' u 2 w l, 'E_BM_M1.0.sxf_minus_Y' u 2 w l