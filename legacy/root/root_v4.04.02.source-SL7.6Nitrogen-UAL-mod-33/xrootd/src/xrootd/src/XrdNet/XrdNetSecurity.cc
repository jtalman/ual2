...
//      $Id: XrdNetSecurity.cc,v 1.1 2004/09/14 06:19:01 abh Exp $

const char *XrdNetSecurityCVSID = "$Id: XrdNetSecurity.cc,v 1.1 2004/09/14 06:19:01 abh Exp $";
...
#define DEBUG(x) if (eTrace) {eTrace->Beg(TraceID); std::cerr << x; eTrace->End();}
