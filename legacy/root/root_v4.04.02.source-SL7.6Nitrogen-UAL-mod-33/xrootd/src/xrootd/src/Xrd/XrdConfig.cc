...
//         $Id: XrdConfig.cc,v 1.19 2005/02/27 22:56:04 abh Exp $

const char *XrdConfigCVSID = "$Id: XrdConfig.cc,v 1.19 2005/02/27 22:56:04 abh Exp $";
...
void XrdConfig::Usage(char *myProg, int rc)
{
     ...
     std::cerr <<"\nUsage: " <<myProg <<" [-c <cfn>] [-d] [-l <fn>] "
            "[-p <port>] [-P <prot>] [<prot_options>]" <<std::endl;
     _exit(rc);
}
