...
TROOT::TROOT(const char *name, const char *title, VoidFuncPtr_t *initfunc)
           : TDirectory()
{
std::cerr << __FILE__ << " " << __LINE__ << " enter TROOT::TROOT(const char *name, const char *title, VoidFuncPtr_t *initfunc)\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __LINE__ << " gGuiFactory " << gGuiFactory << "\n";
std::cerr << __LINE__ << " gGXBatch " << gGXBatch << "\n";
...
std::cerr << __LINE__ << " gVirtualX " << gVirtualX << "\n";
   ...
   fgRootInit = kTRUE;
std::cerr << __FILE__ << " " << __LINE__ << " leave TROOT::TROOT(const char *name, const char *title, VoidFuncPtr_t *initfunc)\n";
}
