...
Bool_t TMatrixFSymCramerInv::Inv2x2(TMatrixFSym &m,Double_t *determ)
{
  if (m.GetNrows() != 2) {
...
//______________________________________________________________________________
Bool_t TMatrixFSymCramerInv::Inv3x3(TMatrixFSym &m,Double_t *determ)
{
  if (m.GetNrows() != 3) {
...
//______________________________________________________________________________
Bool_t TMatrixFSymCramerInv::Inv4x4(TMatrixFSym &m,Double_t *determ)
{
  if (m.GetNrows() != 4) {
  ...
  pM[F01] =  Det3_123_023 * mn1OverDet;
  pM[F02] =  Det3_123_013 * oneOverDet;
  pM[F03] =  Det3_123_012 * mn1OverDet;

  pM[F11] =  Det3_023_023 * oneOverDet;
  pM[F12] =  Det3_023_013 * mn1OverDet;
  pM[F13] =  Det3_023_012 * oneOverDet;

  pM[F22] =  Det3_013_013 * oneOverDet;
  pM[F23] =  Det3_013_012 * mn1OverDet;
...
//______________________________________________________________________________
Bool_t TMatrixFSymCramerInv::Inv5x5(TMatrixFSym &m,Double_t *determ)
{
  if (m.GetNrows() != 5) {
  ...
  pM[M01] = Det4_1234_0234 * mn1OverDet;
  pM[M02] = Det4_1234_0134 * oneOverDet;
  pM[M03] = Det4_1234_0124 * mn1OverDet;
  pM[M04] = Det4_1234_0123 * oneOverDet;

  pM[M11] = Det4_0234_0234 * oneOverDet;
  pM[M12] = Det4_0234_0134 * mn1OverDet;
  pM[M13] = Det4_0234_0124 * oneOverDet;
  pM[M14] = Det4_0234_0123 * mn1OverDet;

  pM[M22] = Det4_0134_0134 * oneOverDet;
  pM[M23] = Det4_0134_0124 * mn1OverDet;
  pM[M24] = Det4_0134_0123 * oneOverDet;

  pM[M33] = Det4_0124_0124 * oneOverDet;
  pM[M34] = Det4_0124_0123 * mn1OverDet;
...
//______________________________________________________________________________
Bool_t TMatrixFSymCramerInv::Inv6x6(TMatrixFSym &m,Double_t *determ)
{
  ...
  pM[A01] =  Det5_12345_02345*mn1OverDet;
  pM[A02] =  Det5_12345_01345*oneOverDet;
  pM[A03] =  Det5_12345_01245*mn1OverDet;
  pM[A04] =  Det5_12345_01235*oneOverDet;
  pM[A05] =  Det5_12345_01234*mn1OverDet;

  pM[A11] =  Det5_02345_02345*oneOverDet;
  pM[A12] =  Det5_02345_01345*mn1OverDet;
  pM[A13] =  Det5_02345_01245*oneOverDet;
  pM[A14] =  Det5_02345_01235*mn1OverDet;
  pM[A15] =  Det5_02345_01234*oneOverDet;

  pM[A22] =  Det5_01345_01345*oneOverDet;
  pM[A23] =  Det5_01345_01245*mn1OverDet;
  pM[A24] =  Det5_01345_01235*oneOverDet;
  pM[A25] =  Det5_01345_01234*mn1OverDet;

  pM[A33] =  Det5_01245_01245*oneOverDet;
  pM[A34] =  Det5_01245_01235*mn1OverDet;
  pM[A35] =  Det5_01245_01234*oneOverDet;

  pM[A44] =  Det5_01235_01235*oneOverDet;
  pM[A45] =  Det5_01235_01234*mn1OverDet;
