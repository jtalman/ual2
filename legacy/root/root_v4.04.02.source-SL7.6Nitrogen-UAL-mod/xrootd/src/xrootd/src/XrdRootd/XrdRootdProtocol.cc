...
//       $Id: XrdRootdProtocol.cc,v 1.9 2005/03/08 17:39:31 ganis Exp $ 

const char *XrdRootdProtocolCVSID = "$Id: XrdRootdProtocol.cc,v 1.9 2005/03/08 17:39:31 ganis Exp $";
...
//
   ...
   std::cerr <<"Xrdrootd: Oops! Exec(" <<Program <<") failed; errno=" <<errno <<std::endl;
   _exit(17);
}
