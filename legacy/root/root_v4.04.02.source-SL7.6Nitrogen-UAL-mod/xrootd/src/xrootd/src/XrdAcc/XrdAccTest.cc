...
//         $Id: XrdAccTest.cc,v 1.5 2005/03/08 18:08:29 ganis Exp $

const char *XrdAccTestCVSID = "$Id: XrdAccTest.cc,v 1.5 2005/03/08 18:08:29 ganis Exp $";
...
void Usage(const char *msg)
     {if (msg) std::cerr <<"testaccess: " <<msg <<std::endl;
      std::cerr << "testaccess [-c cfn] [-d] [user host op path [path [. . .]]]" <<std::endl;
      exit(1);
     }
