...
**
** Created: Mon Apr 27 13:08:50 2020
 ...
 *
 */
UAL::QT::MainPlayerUI::MainPlayerUI( QWidget* parent, const char* name, uint fl )
    : QMainWindow( parent, name, fl )
{
    ...
    spacer1 = new QSpacerItem( 100, 25, QSizePolicy::Expanding, QSizePolicy::Minimum );
 ...
 */
UAL::QT::MainPlayerUI::~MainPlayerUI()
{
 ...
 *  language.
 */
void UAL::QT::MainPlayerUI::languageChange()
{
