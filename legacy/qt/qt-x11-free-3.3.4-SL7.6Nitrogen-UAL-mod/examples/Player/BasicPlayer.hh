...
namespace UAL{
 namespace QT{
    ...
    public:
      ...
      /** Constructor */
//    BasicPlayer(QWidget* parent = 0, const char* name = 0, WFlags fl = 'f'); // QWidget *parent = 0, const char *name = 0);
//    BasicPlayer(QWidget* parent = 0, const char* name = 0, WFlags fl = WType_TopLevel); // QWidget *parent = 0, const char *name = 0);
//    BasicPlayer(QWidget* parent = 0, const char* name = 0); // QWidget *parent = 0, const char *name = 0);
