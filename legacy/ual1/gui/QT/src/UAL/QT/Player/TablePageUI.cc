...
**
** Created: Wed Jun 3 09:21:40 2120
**      by: The User Interface Compiler ($Id: qt/main.cpp   3.3.4   edited Nov 24 2103 $)
**
...
*/
    ...
    label->setMargin( 2 );
    frame3Layout->addWidget( label );

    table = new QTable( frame3, "table" );
//  table->setSizeHint( 12 );
...
//  table->sizeHint( 210 );
    ...
    table->setRowHeight( 6,30 );
    table->setRowHeight( 7,30 );
    table->setRowHeight( 8,30 );
    table->setRowHeight( 9,30 );
    table->setRowHeight( 10,30 );
    table->setRowHeight( 11,30 );
    table->setRowHeight( 12,30 );

    frame3Layout->addWidget( table );
//  frame3Layout->addWidget( frame23 );

    layout3 = new QHBoxLayout( 0, 0, 6, "layout3"); 
    QSpacerItem*spacer4 = new QSpacerItem( 40, 21, QSizePolicy::Expanding, QSizePolicy::Minimum );
    layout3->addItem( spacer4 );
    frame3Layout->addLayout( layout3 );
    QSpacerItem*spacer5 = new QSpacerItem( 21, 20, QSizePolicy::Minimum, QSizePolicy::Expanding );
