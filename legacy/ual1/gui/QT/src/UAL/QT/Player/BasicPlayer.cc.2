...
{
std::cerr << __FILE__ << ": " << __LINE__ << "enter void UAL::QT::BasicPlayer::addEditor(const std::string& className, UAL::QT::BasicEditor* editor)\n";
  m_editors[className] = editor;
std::cerr << __FILE__ << ": " << __LINE__ << "leave void UAL::QT::BasicPlayer::addEditor(const std::string& className, UAL::QT::BasicEditor* editor)\n";
}
...
{
std::cerr << __FILE__ << ": " << __LINE__ << "enter void UAL::QT::BasicPlayer::addViewer(const std::string& className, UAL::QT::BasicViewer* viewer)\n";
  m_viewers[className] = viewer;
std::cerr << __FILE__ << ": " << __LINE__ << "leave void UAL::QT::BasicPlayer::addViewer(const std::string& className, UAL::QT::BasicViewer* viewer)\n";
}
...
{
std::cerr << __FILE__ << ": " << __LINE__ << "enter void UAL::QT::BasicPlayer::initRun()\n";
...
std::cerr << __FILE__ << ": " << __LINE__ << "leave void UAL::QT::BasicPlayer::initRun()\n";
}
