...
//         $Id: XrdOucError.cc,v 1.10 2005/03/11 11:54:38 ganis Exp $

const char *XrdOucErrorCVSID = "$Id: XrdOucError.cc,v 1.10 2005/03/11 11:54:38 ganis Exp $";
...
void XrdOucError::TEnd() {std::cerr << std::endl; Logger->traceEnd();}
