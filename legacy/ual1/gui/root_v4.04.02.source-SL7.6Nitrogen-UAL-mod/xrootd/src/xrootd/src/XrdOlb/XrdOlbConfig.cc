...
//         $Id: XrdOlbConfig.cc,v 1.15 2004/11/04 06:14:48 abh Exp $

const char *XrdOlbConfigCVSID = "$Id: XrdOlbConfig.cc,v 1.15 2004/11/04 06:14:48 abh Exp $";
...
{
std::cerr <<"\nUsage: olbd [-d] [-i] [-l <fn>] [-m] [-s] -c <cfn>" <<std::endl;
exit(rc);
}
