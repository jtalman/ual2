...
{
//std::cerr << __FILE__ << " " << __LINE__ << " enter TVirtualX::TVirtualX(const char *name, const char *title) : TNamed(name, title),TAttLine(1,1,1),TAttFill(1,1),TAttText(11,0,1,62,0.01), TAttMarker(1,1,1)\n";
//std::cerr << __LINE__ << "\n";
   // Ctor of ABC
//std::cerr << __FILE__ << " " << __LINE__ << " leave TVirtualX::TVirtualX(const char *name, const char *title) : TNamed(name, title),TAttLine(1,1,1),TAttFill(1,1),TAttText(11,0,1,62,0.01), TAttMarker(1,1,1)\n";
}

//______________________________________________________________________________
TVirtualX *&TVirtualX::Instance()
{
//std::cerr << __FILE__ << " " << __LINE__ << " enter TVirtualX *&TVirtualX::Instance()\n";
//std::cerr << __LINE__ << "\n";
...
//std::cerr << __LINE__ << "\n";
   if (gPtr2VirtualX){
//std::cerr << __LINE__ << "\n";
    instance = gPtr2VirtualX();
   }
//std::cerr << __LINE__ << "\n";
//std::cerr << __FILE__ << " " << __LINE__ << " leave TVirtualX *&TVirtualX::Instance()\n";
   return instance;
}
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void TVirtualX::GetWindowAttributes(Window_t /*id*/, WindowAttributes_t &attr)\n";
std::cerr << __LINE__ << "\n";
   ...
   attr.fScreen   = 0;
std::cerr << __FILE__ << " " << __LINE__ << " leave void TVirtualX::GetWindowAttributes(Window_t /*id*/, WindowAttributes_t &attr)\n";
}
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void TVirtualX::ClearWindow()\n";
std::cerr << __LINE__ << "\n";
   // Clears the entire area of the current window.
std::cerr << __FILE__ << " " << __LINE__ << " leave void TVirtualX::ClearWindow()\n";
}
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void TVirtualX::SetTextColor(Color_t /*cindex*/)";
   // Sets the color index "cindex" for text.
std::cerr << __FILE__ << " " << __LINE__ << " leave void TVirtualX::SetTextColor(Color_t /*cindex*/)";
}
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void TVirtualX::ClearWindow(Window_t /*id*/)";
std::cerr << __LINE__ << "\n";
   // Clears the entire area in the specified window and it is equivalent to
   // ClearArea(id, 0, 0, 0, 0)
std::cerr << __FILE__ << " " << __LINE__ << " leave void TVirtualX::ClearWindow(Window_t /*id*/)";
}
