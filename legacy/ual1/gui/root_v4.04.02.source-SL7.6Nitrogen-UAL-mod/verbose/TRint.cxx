...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter TRint::TRint(const char *appClassName, Int_t *argc, char **argv, void *options,Int_t numOptions, Bool_t noLogo)\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __FILE__ << " " << __LINE__ << " leave TRint::TRint(const char *appClassName, Int_t *argc, char **argv, void *options,Int_t numOptions, Bool_t noLogo)\n";
}
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void TRint::PrintLogo()\n";
...
#endif
std::cerr << __FILE__ << " " << __LINE__ << " leave void TRint::PrintLogo()\n";
}
