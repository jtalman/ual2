...
protected:
 ...
 public:
   ...
   {
std::cerr << __FILE__ << " " << __LINE__ << " enter TQWidgetCollection () : fWidgetCollection(20) , fIDMax(-1), fIDTotalMax(-1)\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __FILE__ << " " << __LINE__ << " leave TQWidgetCollection () : fWidgetCollection(20) , fIDMax(-1), fIDTotalMax(-1)\n";
   }

   //______________________________________________________________________________
   inline Int_t GetFreeId(QPaintDevice *device) {
std::cerr << __FILE__ << " " << __LINE__ << " enter inline Int_t GetFreeId(QPaintDevice *device)\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __FILE__ << " " << __LINE__ << " leave inline Int_t GetFreeId(QPaintDevice *device)\n";
      return Id;
   }
   //______________________________________________________________________________
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter Int_t  TGQt::RegisterWid(QPaintDevice *wid)\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __FILE__ << " " << __LINE__ << " leave Int_t  TGQt::RegisterWid(QPaintDevice *wid)\n";
   return topDevice;
}
...
std::cerr << __LINE__ << " fWidgetArray " << fWidgetArray << "\n";
...
// if (id == -1) id = 987123;
std::cerr << __LINE__ << "id " << id << "\n";
std::cerr << __FILE__ << " " << __LINE__ << " leave Int_t  TGQt::RegisterWid(QPaintDevice *wid) with ersatz --->>> hopefully valid Int_t id\n";
   return id;
}
//______________________________________________________________________________
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void  TGQt::SelectWindow(int wid)\n";
...
std::cerr << __FILE__ << " " << __LINE__ << " leave void  TGQt::SelectWindow(int wid)\n";
}
