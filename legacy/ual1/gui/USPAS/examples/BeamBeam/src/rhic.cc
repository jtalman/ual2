...
int main(int argc, char** argv)
{
  ...
  logFile << "em1 = " << em1 << ", sigma1 = "   << sqrt(em1*betax) 
	  << std::endl;
  ...
  // ************************************************************************
  logFile << "\nMultipole Tracker . " << std::endl;
  // ************************************************************************ 

  double kl2 = 10*4*1.1e-3;

  PacTwissData sextTwiss;

  sextTwiss.beta(0, 1000.); 
  sextTwiss.beta(1, 20);

  MltTracker mltTracker;
  mltTracker.setTwiss(sextTwiss);
  mltTracker.setSextupole(kl2);

  double sextKick = kl2/2.*(6*em1*sextTwiss.beta(0));

  std::cout << " x sext kick = " << sextKick << std::endl;

  // ************************************************************************
  logFile << "\nBeam-Beam Tracker . " << std::endl;
  // ************************************************************************ 
