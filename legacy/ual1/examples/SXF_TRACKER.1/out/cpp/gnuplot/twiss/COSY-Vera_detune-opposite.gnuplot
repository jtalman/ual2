# gnuplot > load "gnuplot/twiss/COSY-Vera-detune-opposite.gnuplot"
...
set label "deuteron,  E= 2.11 GeV,  {/Symbol b} =0.497" at 100, 24
set title "COSY-Vera-detune-opposite Beta Functions"
...
set output "pdf/COSY-Vera-detune-opposite-Twiss.pdf"
plot "ring.twiss" using 3:4 title "COSY-Vera-detune-opposite-beta_x",\
      "ring.twiss" using 3:8 title "COSY-Vera-detune-opposite-beta_y"

unset label 
set label "deuteron,  E= 2.11 GeV,  {/Symbol b} =0.497" at 100, 0
set ylabel "D [m]"
set title "COSY-Vera-detune-opposite Dispersion Function"
...
set output "pdf/COSY-Vera-detune-opposite-DispersionFunction.pdf"
plot  "ring.twiss" using 3:7 title "COSY-Vera-detune-opposite-eta_x"
