# gnuplot > load "gnuplot/twiss/COSY-Vera-detune.gnuplot"
...
set title "COSY-Vera-detune Beta Functions"
...
set output "pdf/COSY-Vera-detune-Twiss.pdf"
plot "ring.twiss" using 3:4 title "COSY-Vera-detune-beta_x",\
      "ring.twiss" using 3:8 title "COSY-Vera-detune-beta_y"

unset label 
set label "deuteron,  E= 2.11 GeV,  {/Symbol b} =0.497" at 100, 0
set ylabel "D [m]"
set title "COSY-Vera-detune.gnuplot Dispersion Function"
...
set output "pdf/COSY-Vera-detune-DispersionFunction.pdf"
plot  "ring.twiss" using 3:7 title "COSY-Vera-detune-eta_x"
