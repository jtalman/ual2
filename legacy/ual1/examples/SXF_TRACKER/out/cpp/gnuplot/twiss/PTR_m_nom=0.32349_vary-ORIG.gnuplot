...
# set yrange [0:200]
 ...
 set title "PTR mnom=0.32349-varyORIG"
...
# set output '| display png:-'
 set output "pdf/PTR-mnom=0.32349-vary-ORIG-betas.pdf
 plot "ring.twiss" using 3:4 w lp title "PTR-mnom=0.32349-vary-ORIG-beta-horz",\
        "ring.twiss" using 3:8 w lp title "PTR-mnom=0.32349-vary-ORIG-beta-vert"
set output "pdf/PTR-mnom=0.32349-vary-ORIG-phase-advances.pdf
