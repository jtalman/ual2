...
set output "pdf/VLLCnoDSUPP-modTwiss.pdf
 ...
 plot "ring.twiss" using 3:4 title "VLLCnoDSUPP-mod-beta_x",\
        "ring.twiss" using 3:8 title "VLLCnoDSUPP-mod-beta_y",\
        "ring.twiss" using 3:7 title "VLLCnoDSUPP-mod-eta_x"
