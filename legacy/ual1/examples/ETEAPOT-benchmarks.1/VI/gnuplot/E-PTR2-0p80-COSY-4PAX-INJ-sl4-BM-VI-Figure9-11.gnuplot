# gnuplot > load "gnuplot/E-PTR2-0p80-COSY-4PAX-INJ-sl4-BM-VI-Figure9-11.gnuplot"
set xlabel "longitudinal position (m)"
set xrange [0:148.033729]
# set yrange [0:30]

 set grid
 set style data linespoints
 set timestamp "%d/%m/%y %H:%M" offset 1,1 font "Helvetica"
 set title "E-PTR2-0p80-COSY-4PAX-INJ-sl4, m=+/-0.002"
...
#  set output '| display png:-'
 ...
 set output "pdf/E-PTR2-0p80-COSY-4PAX-INJ-sl4-Fig-VI-9-ETEAPOT.pdf"
 plot 'betaFunctions' u 2:3 w l

 set ylabel "vertical beta function, {/Symbol b}_y(m)"
 set output "pdf/E-PTR2-0p80-COSY-4PAX-INJ-sl4-Fig-VI-11-ETEAPOT.pdf"
