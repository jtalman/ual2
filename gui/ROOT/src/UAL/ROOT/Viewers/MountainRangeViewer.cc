...
UAL::ROOT::MountainRangeViewer::MountainRangeViewer(UAL::QT::BasicPlayer* player, 
						    PAC::Bunch* bunch) : UAL::ROOT::BasicViewer(){
std::cout << __FILE__ << ": " << __LINE__ << " enter UAL::ROOT::MountainRangeViewer::MountainRangeViewer\n";
  p_player     = player;
  p_bunch      = bunch;
...
std::cout << __LINE__ << " m_nbins " << m_nbins << "\n";
std::cout << __LINE__ << " m_nsteps " << m_nsteps << "\n";
std::cout << __FILE__ << ": " << __LINE__ << " leave UAL::ROOT::MountainRangeViewer::MountainRangeViewer\n";
}
