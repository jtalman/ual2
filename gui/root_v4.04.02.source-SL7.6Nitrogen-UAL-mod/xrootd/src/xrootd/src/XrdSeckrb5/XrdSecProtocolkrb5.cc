...
//       $Id: XrdSecProtocolkrb5.cc,v 1.8 2005/03/15 01:47:39 abh Exp $

const char *XrdSecProtocolkrb5CVSID = "$Id: XrdSecProtocolkrb5.cc,v 1.8 2005/03/15 01:47:39 abh Exp $";
...
#define CLDBG(x) if (options & XrdSecDEBUG) std::cerr <<"Seckrb5: " <<x <<std::endl;
