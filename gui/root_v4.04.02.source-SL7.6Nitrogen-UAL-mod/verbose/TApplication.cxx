...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter TApplication::TApplication()\n";
std::cerr << __LINE__ << "\n";
   ...
   fIdleTimer     = 0;
   fSigHandler    = 0;
std::cerr << __FILE__ << " " << __LINE__ << " leave TApplication::TApplication()\n";
}
...
TApplication::TApplication(const char *appClassName,
                           ...
                           Int_t numOptions)
{
std::cerr << __FILE__ << " " << __LINE__ << " enter TApplication::TApplication(const char *appClassName,Int_t *argc, char **argv, void *options,Int_t numOptions)\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __LINE__ << "gVirtualX->GetName() " << gVirtualX->GetName() << "\n";
...
std::cerr << __FILE__ << " " << __LINE__ << " leave TApplication::TApplication(const char *appClassName,Int_t *argc, char **argv, void *options,Int_t numOptions)\n";
}
...
{
std::cerr << __FILE__ << " " << __LINE__ << " enter void TApplication::LoadGraphicsLibs()\n";
std::cerr << __LINE__ << "\n";
...
std::cerr << __LINE__ << " typeid(gGuiFactory).name() " << typeid(gGuiFactory).name() << "\n";
   }
std::cerr << __FILE__ << " " << __LINE__ << " leave void TApplication::LoadGraphicsLibs()\n";
}
